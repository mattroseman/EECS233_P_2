...
public class HuffmanNodeFundTest {
    ...
    public void testArrayArgumentConstructorAndToString() {
    	...
    	assertEquals("Your constructors should initialize the byte and count members " + 
                ...
                null, hn.right);
        HuffmanNode lChild = new HuffmanNode((byte)'l', 6);
        HuffmanNode rChild = new HuffmanNode((byte)'r', 3);
        HuffmanNode lrParent = new HuffmanNode((byte)'p', 5, lChild, rChild);
        assertEquals("The constructor should initialize the byte and count memebers based on the passed arguments",
        		(byte)'p', lrParent.b);
        assertEquals("The constructor should initialize the byte and count members including the left and right subtrees",
        		5+6+3, lrParent.count);
    }
